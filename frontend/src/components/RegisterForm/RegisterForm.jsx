...
const RegisterForm = () => {
  ...
  const handleRegister = async (_name, _type) => {
    ...
    try {
      ...
      switch (_type) {
        case 0:
          registrationResponse = await Services.registerCoalProducer(_name);
          break;
        case 1:
          registrationResponse = await Services.registerRailway(_name);
          break;
        case 2:
          registrationResponse = await Services.registerElecProducer(_name);
          break;
      }
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} fullWidth>
            <Select
              ...
              fullWidth
            >
              <MenuItem value={0}>CoalProducer</MenuItem>
              <MenuItem value={1}>Railway</MenuItem>
              <MenuItem value={2}>ElecProducer</MenuItem>
            </Select>
          </Grid>
          <Grid item xs={12}>
